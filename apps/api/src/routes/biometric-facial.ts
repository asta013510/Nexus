 ...
 */
router.post('/facial/enroll', authMiddleware.requireAuth, authMiddleware.requireStepUp, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/facial/liveness', async (req: Request, res: Response) => {
  try {
 ...
 */
router.delete('/facial', authMiddleware.requireAuth, authMiddleware.requireStepUp, async (req: Request, res: Response) => {
  try {
    const userId = req.user?.userId;
    if (!userId) throw new Error('User ID not found');
