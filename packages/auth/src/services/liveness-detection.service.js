...
exports.LivenessDetectionService = void 0;
class LivenessDetectionService {
    static MAX_CHALLENGE_ATTEMPTS = 3;
    static CHALLENGE_TIMEOUT_MS = 10000;
    /**
     ...
     */
    static async analyzeLiveness(challenge, userResponse) {
        ...
        const finalScore = ((motionScore * 0.25) +
            (textureScore * 0.25) +
            (depthScore * 0.25) +
            (challengeScore * 0.25));
     ...
     */
    static detectReplayAttack(frames) {
...
//# sourceMappingURL=liveness-detection.service.js.map